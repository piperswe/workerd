...
private:
  ...
  public:
    ...
    kj::Promise<void> connect(
        ...
        ConnectResponse& tunnel, kj::HttpClient::ConnectSettings settings) override {
      return parent.serviceAdapter->connect(host, headers, connection, tunnel, settings);
    }
...
private:
  ...
  kj::Promise<void> connect(
    ...
    return serviceAdapter->connect(host, headers, connection, tunnel, settings);
  }
